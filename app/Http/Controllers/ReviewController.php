    ...
    public function create()
{
    ...
    if (!$hasCompletedAppointment) {
        return redirect()->route('patients.reviews.index')
            ->with('error', __('Anda tidak dapat menambahkan review sebelum menyelesaikan janji temu.'));
    }
    ...
    if (!$patient) {
        return redirect()
            ...
            ->with('error', __('Anda tidak dapat menambahkan review tanpa menjadi pasien.'));
    }
