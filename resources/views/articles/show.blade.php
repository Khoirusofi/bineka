<x-landing-layout>
    ...
    <section id="hero" class="grid items-center gap-8 py-20">
        <x-heading level="h1">
            ...
            <figcaption class="items-center justify-center text-center text-sm text-gray-400"> Ilutrasi
                {{ $article->title }}
            </figcaption>

            <div
                class="p-8 mx-auto prose prose-headings:font-sans prose-headings:tracking-normal max-w-none prose-p:leading-relaxed prose-pink">
                {!! $article->body !!}
            </div>
        </x-heading>
    </section>
    ...
    <section id="comment" class="py-20">
        <div class="px-4 max-w-full"> <!-- Hapus mx-auto dan atur max-w ke full -->
            <div class="flex flex-col items-start justify-start mb-6">
                <div class="flex justify-between items-center mt-4">
                    ...
                    @else
                        <x-button label="{{ __('Login') }}">{{ __('Login') }}</x-button>
                                            ...
                                            <ul class="py-1 text-sm text-gray-700"
                                                ...
                                                <li>
                                                    <form action="{{ route('comments.destroy', $comment) }}"
                                                        ...
                                                        @method('DELETE')
                                                        <button type="submit"
                                                            class="flex items-center w-full text-left py-2 px-4 text-[10px] hover:bg-zinc-50 text-red-500">
