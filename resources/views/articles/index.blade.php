                    ...
                    <div class="absolute top-2 right-2">
                        <div class="relative">
                            <button type="button" id="dropdownButton"
                                data-dropdown-toggle="dropdown-{{ $loop->index }}" data-dropdown-placement="bottom-end"
                                class="focus:outline-none flex items-center space-x-1">
                                <i class="ri-share-line text-white text-xl hover:text-[#3e6553] transition p-1 "></i>
                            </button>
                            <!-- Dropdown Menu -->
