<x-landing-layout>
            ...
            <div class="flex flex-col md:flex-row items-center justify-between">
                <div class="flex flex-col gap-y-10 md:w-1/2">
                    <div class="flex justify-between">
                        ...
                        <!-- Elemen Kanan -->
                        {{-- <div
                            class="w-fit gap-x-2 px-5 py-1 small-badge flex flex-row font-semibold bg-[#e6efeb] rounded-full ml-10">
                            <p class="text-base text-[#252826] flex items-center">
                                <i class="ri-health-book-line mr-1"></i>
                                {{ __('Service 24 Jam') }}
                            </p>
    ...
    <section class="galeri max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-16" id="galeri">
        <div class="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
            <div class="max-w-2xl mx-auto text-center">
                ...
                <p class="max-w-xl mx-auto mt-2 mb-6 text-center text-base leading-loose text-[#565d59]">Explore the
                    common
                    questions and answers about Celebration</p>
            </div>
                    ...
                    <div class="w-full md:w-1/2 flex flex-wrap">
                        @foreach ([1, 2, 3] as $id)
                            ...
                            @if ($photo)
                                @if ($id == 1 || $id == 2)
                                    <div class="w-1/2 p-2">
                                        <a href="{{ asset('media/photo/' . $photo->photo) }}" data-lightbox="gallery"
    ...
    <section id="testimonial" class=" testimonial max-w-6xl mx-auto">
        <div class="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
            ...
            <div class="flex overflow-x-scroll gap-8 mx-4 py-2 no-scrollbar cursor-pointer" id="scrollContainer">
                @foreach ($uniqueReviews as $review)
                    <div class="p-6 space-y-4 bg-white rounded-xl shadow-lg min-w-[300px]">
